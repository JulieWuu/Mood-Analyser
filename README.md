...
A small program that is able to read my Excel mood tracker and store information in json format. <br>
Mood level is distinguished by the colour of text in each cell, and the cells are arranged 7 per row, corresponding 7 days in a week. <br>
